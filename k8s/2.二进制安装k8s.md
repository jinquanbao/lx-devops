...
etcdctl --endpoints="192.168.23.103:2379,192.168.23.102:2379,192.168.23.101:2379" --cacert=/etc/kubernetes/pki/etcd/etcd-ca.pem --cert=/etc/kubernetes/pki/etcd/etcd.pem --key=/etc/kubernetes/pki/etcd/etcd-key.pem  endpoint status --write-out=table
```

![image-20220823140746656](./images/image-20220823140746656.png)
...
● kube-apiserver.service - Kubernetes API Server
   ...
   Active: active (running) since Sat 2022-08-23 21:26:49 CST; 26s ago 
```
